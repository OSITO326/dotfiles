...
vim.keymap.set("n", "<leader>de", require("dap-config.dap-fn").stop, { noremap = true })
...
vim.keymap.set("n", "<leader>ds", require("dap-config.dap-fn").scopes, { noremap = true })
vim.keymap.set("n", "<leader>da", require("dap-config.dap-fn").fullscopes, { noremap = true })
